...
function isSemantic(message) {
  if (message.startsWith('fix:')) return true
  if (message.startsWith('feat:')) return true
  if (message.startsWith('BREAKING CHANGE:')) return true
  return false
}
